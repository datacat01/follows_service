...
config :kaffe,
  producer: [
    ...
    topics: ["follows_topic", "followers_num_topic", "followers_all_topic"], # add a list of topics you plan to produce messages to
  ]

config :kaffe,
  consumer: [
    endpoints: [localhost: 9092],               
    topics: ["follow_topic", "followed_topic"],     # the topic(s) that will be consumed
